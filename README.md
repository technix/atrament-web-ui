...
| `[banner]text[/banner]` | Display text as an banner block. Since this is a block element, it is recommended to use it on a whole paragraph.<br>Attributes:<br>`style=accent` use accent color<br>`allcaps=true` display text in all capitals<br>`align=left` text alignment: `left`, `right`, or `center` (default)<br>`border=none` banner borders: `both` (default), `top`, `bottom`, or `none` |
...
| Theme parameter | Description                |
| :-------- | :------------------------- |
| id | Application identifier in a reverse-DNS format. |
| name | Application display name. |
| description | Application description. |
| version | Version number in major-minor-patch notation. |
