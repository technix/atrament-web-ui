...
const ChoiceButton = ({ choice, chosen, index, handleClick, choiceAppearance }) => {
  ...
  const choiceGroupClass = (choiceAppearance.grouped && !choiceAppearance.grid) ? (choiceAppearance.row ? style.buttons_grouped_row : style.buttons_grouped) : style.buttons_separate;
